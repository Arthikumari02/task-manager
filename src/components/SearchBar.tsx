    ...
    return (
      <>
        ...
        <button
          ...
          className={`p-1 rounded transition duration-200 ${showSearchResults ? 'bg-[#4E97C2] text-white' : 'bg-[#4E97C2] hover:bg-[#4E97C2] text-white'}`}
          title="Search"
        >
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-10 py-2 border-0 rounded text-sm bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200"
                    autoFocus
                  />
                  {searchQuery && (
                    <button
